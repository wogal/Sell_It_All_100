...
public class Text_Input_Dialog_v14 implements View.OnClickListener {
    private Text_Inp_Dia_Key_Response_Interface mText_inp_dia_key_response_Listerner;
    ...
    public void setEventListener_Call_Back (Text_Inp_Dia_Key_Response_Interface _eventListener) {
