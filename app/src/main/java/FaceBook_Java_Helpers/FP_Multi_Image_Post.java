 ...
 * Will post multibule images's onto face book
 * will post ALL images as one post ,,,  if   " _set_ALL_Item_One_Post " == true
 * set constructor with params then invoke run
 *
 * there are 3 call backs
 *
 * 1/
 *
 *
