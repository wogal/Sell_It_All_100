...
public class Recycley_view_Activity_Mngr_Posts_v11 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        setContentView( R.layout.test_recycley_view_layout_posts_v11 );
        mRecyclerView = (RecyclerView) findViewById( R.id.Rec_Posts_v11QQQq );
